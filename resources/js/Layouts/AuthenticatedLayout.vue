<template>
  <div
    class="main-section antialiased relative font-normal"
    ...
    <div class="relative">
      ...
      <div
        class="main-container text-black dark:text-white-dark min-h-screen navbar-sticky"
        :class="[store.navbar]">
        <!--  BEGIN SIDEBAR  -->
        <Sidebar />
        <!--  END SIDEBAR  -->
